    ...
    function startImageHeader() {
        ...
        new preLoader([dataHeader[activeIndex].bigImage, dataHeader[prevIndex].bigImage, dataHeader[nextIndex].bigImage], {
            onComplete: function (loaded, errors) {
                ...
                activeSlide.css("background-size", "100% 100%");
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title text-center" id="exampleModalLabel">Đăng ký gói cước <strong>`+ b.name +`</strong></h4>
            ...
            <div class="modal-body">
                ...
                <ul class = "modalul">
                <li>Giá: ` + b.price + `</li>
                <li>Tự động đăng ký lại: ` + b.resign + `</li>
                <li>Thòi Hạn: ` + b.exp + `</li>
                <li>Chi tiết: ` + b.detail + `</li>
                </ul>
                <\div>
            </div>
            <div class="modal-footer">
                ...
                <a href="https://shop.viettel.vn/frame/dang-ky-goi-cuoc?code=` + b.name + `&ch=hieunt_nan_ddv" class="btn btn-danger" role="button" target="_blank" aria-pressed="true">Đăng ký ngay</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    var portList = $('<figure class="portfolio-view ' + b.category + '" style="width:' + portWidth + 'px;height:' + (portWidth - 113) + 'px"><img src="' + image + '"><figcaption><h2>' + b.title + '</span></h2><p>' + b.text + '</p><a data-toggle="modal" data-target="#exampleModal' + a + '">View more</a></figcaption></figure> ' + modal );
